/**
  @page adc_polling_single ADC single mode example
  
  @verbatim
  ******************************************************************************
  * @file    adc/adc_polling_single/readme.txt 
  * @author  MCU Software Team
  * @Version V1.2.0
  * @Date    2021-01-11
  * @brief   Description of the ADC polling single example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - ADC Channel4(PD3-J6.1) will be converted alternately 
