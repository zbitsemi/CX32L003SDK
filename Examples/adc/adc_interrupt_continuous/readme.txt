/**
  @page adc_interrupt_continuous ADC continuous mode example
  
  @verbatim
  ******************************************************************************
  * @file    adc/adc_interrupt_continuous/readme.txt 
  * @author  MCU Software Team
  * @Version V1.2.0
  * @Date    2021-01-11
  * @brief   Description of the ADC interrupt continuous example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - ADC Channel4(PD3-J6.1) and Channel7(internal VCAP voltage) will be converted alternately 
