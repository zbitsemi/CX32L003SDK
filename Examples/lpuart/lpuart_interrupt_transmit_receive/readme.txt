/**
  @page lpuart_interrupt_transmit_receive LPUART interrupt transmit and receive example
  
  @verbatim
  ******************************************************************************
  * @file    lpuart/lpuart_interrupt_transmit_receive/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the LPUART interrupt transmit and receive example.
  ******************************************************************************
  @endverbatim
