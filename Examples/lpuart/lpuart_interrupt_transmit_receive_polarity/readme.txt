/**
  @page lpuart_interrupt_transmit_receive_polarity LPUART interrupt transmit and receive with polarity example
  
  @verbatim
  ******************************************************************************
  * @file    lpuart/lpuart_interrupt_transmit_receive_polarity/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the LPUART interrupt transmit and receive with polarity example.
  ******************************************************************************
  @endverbatim
