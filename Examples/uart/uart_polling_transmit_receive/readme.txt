/**
  @page uart_polling_transmit_receive UART polling transmit and receive example
  
  @verbatim
  ******************************************************************************
  * @file    uart/uart_polling_transmit_receive/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the UART polling transmit and receive example.
  ******************************************************************************
  @endverbatim
