/**
  @page adc_polling_continuous_acc ADC continuous accumulate mode example
  
  @verbatim
  ******************************************************************************
  * @file    adc/adc_polling_continuous_acc/readme.txt 
  * @author  MCU Software Team
  * @Version V1.2.0
  * @Date    2021-01-11
  * @brief   Description of the ADC polling continuous accumulate example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - Channel7(internal VCAP voltage) will be converted and accumulated 
