/**
  @page lpuart_polling_transmit_receive_polarity LPUART polling transmit and receive with polarity example
  
  @verbatim
  ******************************************************************************
  * @file    lpuart/lpuart_polling_transmit_receive_polarity/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the LPUART polling transmit and receive with polarity example.
  ******************************************************************************
  @endverbatim
