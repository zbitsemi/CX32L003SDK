/**
  @page awk_sleep AWK sleep example
  ...
  * @Version V1.2.0
  * @Date    2021-01-11
  * @brief   Description of the AWK sleep example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example 
 - LED will flash with 500ms interval because AWK wake up system from sleep mode.
