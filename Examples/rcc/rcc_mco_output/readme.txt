/**
  @page rcc_mco_output RCC MCO ouput example
  
  @verbatim
  ******************************************************************************
  * @file    rcc/rcc_mco_output/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the RCC MCO ouput example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Press user button(USR SW1), clock switch message will be sent to PC terminal.  
 */
