...
#define TIMx_FREQ																10000 // 预分频后 TIM时钟频率 注意预分频值是否为整数
/* If TIMx clock 10K ---> 1s */
#define TIMx_PERIOD															(10000-1) // 计数值 Max=65535 最快us级 程序指令跑不过来
 

#define TIMx_CH1_PULSEWIDTH											1000  // CCR1通道值 注意 0<CCRx
...
#define __HAL_RCC_TIMxCH1OUT_GPIOCLK_ENABLE()		__HAL_RCC_GPIOC_CLK_ENABLE()
#define TIMx_CH1OUT_PORT												GPIOC	
#define TIMx_CH1OUT_PIN													GPIO_PIN_6
