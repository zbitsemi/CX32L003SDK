/**
  @page lvd_interrupt LVD interrupt example
  
  @verbatim
  ******************************************************************************
  * @file    lvd/lvd_interrupt/readme.txt 
  * @author  MCU Software Team
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the LVD interrupt example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - Adjust VCC power supply down to around 2.9V, LVD interrupt will generate. 
