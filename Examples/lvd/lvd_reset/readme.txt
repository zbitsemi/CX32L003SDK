/**
  @page lvd_reset LVD reset example
  ...
  * @version V1.0.0
  * @date    21-Oct-2019
  * @brief   Description of the LVD reset example.
  ******************************************************************************
  @endverbatim
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - Adjust VCC power supply down to around 2.9V, CX32L003 will reset due to LVD module. 
