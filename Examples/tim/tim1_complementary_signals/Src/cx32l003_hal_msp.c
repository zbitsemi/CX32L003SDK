...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim)
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
	...
	__HAL_RCC_TIMxCH3NOUT_GPIOCLK_ENABLE();
	GPIO_InitStruct.Pin = TIMx_CH3NOUT_PIN;		
	GPIO_InitStruct.Alternate = TIMx_CH3NOUT_GPIO_AFn;
	HAL_GPIO_Init(TIMx_CH3NOUT_PORT, &GPIO_InitStruct);	
	...
	__HAL_RCC_BKIN_GPIOCLK_ENABLE();
	GPIO_InitStruct.Pin = TIMx_BKIN_PIN;		
	GPIO_InitStruct.Alternate = TIMx_BKIN_GPIO_AFn;
